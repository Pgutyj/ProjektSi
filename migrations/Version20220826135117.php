 ...
 */
final class Version20220826135117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE authorInfos (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) NOT NULL, slug VARCHAR(128) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservations (id INT AUTO_INCREMENT NOT NULL, reservation_status_id INT DEFAULT NULL, book_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, reservation_time DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_4DA23971B06122 (reservation_status_id), UNIQUE INDEX UNIQ_4DA23916A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
